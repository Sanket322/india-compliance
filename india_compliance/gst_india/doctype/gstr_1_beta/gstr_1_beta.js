...
class BooksTab extends TabManager {
    ...
    download_books_as_excel() {
        open_url_post(
            "/api/method/india_compliance.gst_india.utils.gstr_1.gstr_1_beta-exports.download_books_as_excel",
            {
                data: this.data,
                company_gstin: this.instance.frm.fields_dict.company_gstin.value,
                month: this.instance.frm.fields_dict.month.value,
                year: this.instance.frm.fields_dict.year.value,
            }
        );
    }
